...
```{r}
missing_patterns <- data.frame(is.na(Lock5withR::HollywoodMovies2011)) %>%
  group_by_all() %>%
...
```{r}
num_of_rows <- nrow(Lock5withR::HollywoodMovies2011)
...
=======
p_variable_hist + plot_spacer() + p_tile + p_pattern_hist +  plot_layout(widths = c(5, 1), heights = c(2, 8))
>>>>>>> e8d7e8b1c740b9015d1d97e11cba2fa1810370e6
```
